...
; Drives
	; Mappings
		...
		M569 P0.3 S1                               	; physical drive 0.3 goes forwards ZLeft
		M569 P0.4 S1                                	; physical drive 0.4 goes forwards ZRight
...
; Leds			
	M950 F4 C"out1"											; map out1 as top leds
	M106 P4 B3 C"LEDs"										; create fan named LEDs and lit for B secs
